...
parent: "Spørgsmål"
permalink: /spoergsmaal/løst-under-selve-elementet-vælges-quotdisplay-onquot-og-sa-quotboth-form-and/
...
Hvordan får jeg feltet "Advanced HTML" med, når man anvender følgende på en given Email handler:   
[webform_submission:values]

Jeg sidder med en formular der skal fungere som samtykke til en given aftale. Helt konrekt aftale om tandregulering i den kommunale tandpleje.
...
Mads (Rudersdal Kommune)

Jeg har således oprettet en handler der sender 
