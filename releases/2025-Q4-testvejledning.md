...
9. [**#227**](https://github.com/OS2Forms/os2forms/issues/227)**: Conditionals based on computed twig broken in Drupal ^10.3**
   ...
   Jeg vil foreslå at testen går ud på at se om man kan reproducere fejlen eller ej. Problem/Motivation. With a webform that uses the result of the computed twig as a visibility condition, in Drupal 10.3 the form element that has a visibility condition no longer shows/hides. Steps to reproduce:
